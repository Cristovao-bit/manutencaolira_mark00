<?php
define('HOME', 'http://localhost/manutencao_lira/projeto_manutencao_lira');
...
define('MAILPORT', '465');
define('MAILHOST', 'manutencaolira.com.br');
...
$pg_fb_page = 'Manutenção Lira - Suporte Técnico em Tecnologia';
