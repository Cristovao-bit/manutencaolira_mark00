    ...
    <section class="container footer_content">
        <article class="main_company">
            <div class="company_header">
                <div>
                    <img title="MANUTENÇÃO LIRA - Suporte Técnico em Tecnologia" alt="[MANUTENÇÃO LIRA - Suporte Técnico em Tecnologia]" src="<?= INCLUDE_PATH; ?>/_img/logo-empresa.png"/>
        ...
        <article class="main_contact">
            ...
            <ul>
                ...
                <ul class="main_contact_redes">
                    <li><a class="radius-circle" href="https://www.facebook.com/Manutencaoliraemtecnologia" target="_blank" title="Facebook | Manutenção Lira"><i class="icon icon-facebook"></i></a></li>
                    <li><a class="radius-circle" href="https://www.instagram.com/manutencaoliraemtecnologia" target="_blank" title="Instagram | Manutenção Lira"><i class="icon icon-instagram"></i></a></li>
                    <li><a class="radius-circle" href="https://twitter.com/LiraTecnico" target="_blank" title="Twitter | Manutenção Lira"><i class="icon icon-twitter"></i></a></li>
                    <li><a class="radius-circle" href="https://www.linkedin.com/in/cristov%C3%A3o-lira-braga-985607172" target="_blank" title="Linkedin | Manutenção Lira"><i class="icon icon-linkedin"></i></a></li>
                </ul>
            </ul>
        </article>
    </section>
